...
def reverse_edges(edges_list):
        """
        Takes a list of edges and reverses the direction of all the edges.

        Parameters:
        edges_list (list of tuples): The list of edges to reverse.

        Returns:
        list of tuples: The list with each edge's direction reversed.
        """
...
def reverse_list(input_list):
    """
    Takes a list and returns a new list in reversed order.

    Parameters:
    input_list (list): The list to reverse.
